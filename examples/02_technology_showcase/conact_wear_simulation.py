...
normal_stress_image = cwd / "normal_stress"
graphics.ExportImage(str(normal_stress_image), image_export_format, settings_720p)
...
mechdat_file = cwd / "contact_wear.mechdat"
